...
function Sidebar() {
  ...
  return (
    <>
     <div className="w-[320px] h-[985px] bg-[#1D1429] rounded-3xl p-10">
        <div className="flex flex-col text-center items-center flex-start mb-12 text-white pl-7">
            <img className="mr-7" src={sidebar_logo} alt="Logo" />
        ...
        <div className="flex flex-col justify-between flex-1 pl-7">
            <ul className=" pr-7 list-none">
                <li>
                    <a href="/" className="px-2 py-2 my-2 flex items-center text-white active:bg-blue-500 hover:bg-blue-900 rounded-md cursor-pointer">
                ...
                <li>
                    <a href='/firewall_details' className="px-2 py-2 my-2 flex items-center text-white active:bg-blue-500 hover:bg-blue-900 rounded-md cursor-pointer">
